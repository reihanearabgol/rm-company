...
const STEPS = [
  {
    num: '01',
    title: 'Discovery',
    desc: 'We begin with a complimentary consultation to understand your vision, lifestyle, and goals. No obligation — just a genuine conversation about your space.',
    duration: '1–2 hours',
  },
  {
    num: '02',
    title: 'Design',
    desc: 'Our designers craft a detailed concept — materials, finishes, layouts, and 3D visualisations. You review, refine, and approve before anything begins.',
    duration: '1–2 weeks',
  },
  {
    num: '03',
    title: 'Planning',
    desc: 'Full project scheduling, permits, contractor coordination, and budget finalisation. Every detail is locked in before a single wall is touched.',
    duration: '1–3 weeks',
  },
  {
    num: '04',
    title: 'Build',
    desc: 'Expert tradespeople execute the work with precision, under daily management by your dedicated project lead. You receive daily progress updates.',
    duration: 'Project dependent',
  },
  {
    num: '05',
    title: 'Reveal',
    desc: 'A final walkthrough, snag resolution, and handover — with our 5-year workmanship guarantee. Your home, transformed.',
    duration: '1–2 days',
  },
]
...
export default function ProcessPage() {
  return (
    <main style={{ background: '#0a0908', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 5vw 8rem' }}>
        {STEPS.map((step, i) => (
          <div
            key={step.num}
            style={{
          ...
          >
            ...
            <div style={{ paddingTop: '0.75rem', paddingBottom: '1rem' }}>
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: '1rem', flexWrap: 'wrap', gap: '0.5rem' }}>
                <h2 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(1.8rem,3vw,2.4rem)', fontWeight: 300, color: '#e8dcc8', lineHeight: 1.1 }}>{step.title}</h2>
                <span style={{
                  fontFamily: 'DM Sans, sans-serif', fontSize: '0.65rem',
                  letterSpacing: '0.12em', color: 'rgba(201,169,110,0.6)',
      ...
      <div style={{ background: '#1c1b19', borderTop: '1px solid rgba(201,169,110,0.1)', borderBottom: '1px solid rgba(201,169,110,0.1)', padding: '3.5rem 5vw' }}>
        <div style={{ maxWidth: '1320px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '0' }}>
          {[
            { num: '5 Year', label: 'Workmanship Guarantee' },
            { num: '96%',    label: 'On-Time Delivery Rate' },
            { num: '1',      label: 'Dedicated Project Lead' },
          ].map((stat, i) => (
            <div key={i} style={{ textAlign: 'center', padding: '0 2rem', borderRight: i < 2 ? '1px solid rgba(201,169,110,0.12)' : 'none' }}>
              <span style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: '2.5rem', fontWeight: 300, color: '#c9a96e', display: 'block', marginBottom: '0.5rem' }}>{stat.num}</span>
