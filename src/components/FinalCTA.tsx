  ...
  return (
    <section id="finalcta" style={{ background: '#0a0908', padding: '10rem 4rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '700px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '1rem', fontWeight: 300, color: '#a09890', lineHeight: 1.8, maxWidth: '520px', margin: '0 auto 3rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="/consultation" style={{ display: 'inline-block', padding: '1.1rem 2.75rem', background: '#c9a96e', color: '#0a0908', fontFamily: "'DM Sans', sans-serif", fontSize: '0.7rem', letterSpacing: '0.15em', textTransform: 'uppercase', textDecoration: 'none', transition: 'background 0.3s ease, transform 0.3s ease' }}
          ...
          <a href="#projects" style={{ display: 'inline-block', padding: '1.1rem 2.75rem', background: 'transparent', color: '#f5f0e8', fontFamily: "'DM Sans', sans-serif", fontSize: '0.7rem', letterSpacing: '0.15em', textTransform: 'uppercase', textDecoration: 'none', border: '1px solid rgba(245,240,232,0.3)', transition: 'border-color 0.3s ease' }}
